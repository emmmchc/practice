    ...
    ui(new Ui::ClassManage)
{
    ...
    tabModel->setTable("class");
    tabModel->setEditStrategy(QSqlTableModel::OnManualSubmit);
    tabModel->setHeaderData(0,Qt::Horizontal,"班级ID");
    tabModel->setHeaderData(1,Qt::Horizontal,"班级");
    tabModel->select();
}
...
void ClassManage::on_submit_btn_clicked()
{
    // 开始事务操作
...
void ClassManage::on_cancel_btn_clicked()
{
    tabModel->revertAll();
}

void ClassManage::on_add_btn_clicked()
{
    //获得表的行数
...
void ClassManage::on_del_btn_clicked()
{
